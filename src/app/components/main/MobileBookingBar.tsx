...
export default function MobileBookingBar({
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[80] border-t border-[#eadfca] bg-white/95 px-3 py-3 shadow-[0_-8px_24px_rgba(26,26,46,0.1)] backdrop-blur-md md:hidden">
      <button
        type="button"
        disabled
